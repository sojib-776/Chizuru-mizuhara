...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
    ...
    if ((event.body.toLowerCase() == "😘") || (event.body.toLowerCase() == "😽")) {
     ...
     return api.sendMessage("কাছে এসো .....  🫣", threadID);
    ...
    if ((event.body.toLowerCase() == "👍🏼") || (event.body.toLowerCase() == "👍")) {
     ...
     return api.sendMessage("আঙুলটা পিছে ভরে নে 🐸👍", threadID);
   ...
   if ((event.body.toLowerCase() == "...") || (event.body.toLowerCase() == "...") ||(event.body.toLowerCase() == "...") || (event.body.toLowerCase() == "...")) {
     ...
     return api.sendMessage("এত হাই-হ্যালো দুচাস কেন..?  👽➗", threadID);
   ...
   if ((event.body.toLowerCase() == "morning") || (event.body.toLowerCase() == "good morning")) {
     ...
     return api.sendMessage("GOOD MORNING দাত ব্রাশ করে সজিবের রুম এ চলে যাও 😚", threadID);
   ...
   if ((event.body.toLowerCase() == "tor ball") || (event.body.toLowerCase() == "bal")) {
     ...
     return api.sendMessage("~ তোমার তো ধনই নাই...! আর বাল...?😒", threadID);
  ...
  if ((event.body.toLowerCase() == "@odd sojib") || (event.body.toLowerCase() == "Sojib") || (event.body.toLowerCase() == "@Ullash ッ") || (event.body.toLowerCase() == "সজিব")) {
   ...
   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     ...
     return api.sendMessage("My Creator:SOJIB  ❤️ হাই আমি মেছেন্জার ROBOT  আামার সার সজিব আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
  ...
  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     ...
     return api.sendMessage("TERA BAP OR MERA ADMIN SOJIB REZA ✨🔖 ", threadID);
   ...
   if ((event.body.toLowerCase() == "chup") || (event.body.toLowerCase() == "stop") || (event.body.toLowerCase() == "চুপ কর") || (event.body.toLowerCase() == "chup kor")) {
     ...
     return api.sendMessage("তুই চুপ কর শালা নিগগা 😤", threadID);
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "sala ami tor boss") || (event.body.toLowerCase() == "sala ami ullas") || (event.body.toLowerCase() == "cup sala ami sojib") || (event.body.toLowerCase() == "Sojib")) {
   ...
   if ((event.body.toLowerCase() == "Atiya") || (event.body.toLowerCase() == "@sijuka sijuka ")) {

     return api.sendMessage("খবরদার কেউ ভাবিকে  মেনশন দিবানা এটা আমার সার সজিব এর সব কিছু  😾🔪", threadID);

   };



  if ((event.body.toLowerCase() == "Sadia") || (event.body.toLowerCase() == "Sneha")) {

     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার সার সজিব এর বউ এর নাম..! 😾🔪", threadID);
  ...
  if ((event.body.toLowerCase() == "Jakia") || (event.body.toLowerCase() == "@Jakia Sultana ")) {
  ...
  if ((event.body.toLowerCase() == "@Md fardin") || (event.body.toLowerCase() == "Raihan")) {

     return api.sendMessage("এরা আমার সার সজিব এর বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক 😒🔪", threadID);
   ...
   if ((event.body.toLowerCase() == "tnx") || (event.body.toLowerCase() == "ধন্যবাদ") || (event.body.toLowerCase() == "thank you") || (event.body.toLowerCase() == "thanks")) {
     ...
     return api.sendMessage("️এতো ধন্যবাদ না দিয়ে পারলে সজিব সারকে গার্লফ্রেন্ড টা দিয়ে দে..!🌚⛏️🌶️", threadID);
   ...
   if ((event.body.toLowerCase() == "....") || (event.body.toLowerCase() == "...") || (event.body.toLowerCase() == "😠") || (event.body.toLowerCase() == "🤬") || (event.body.toLowerCase() == "😾")) {
     ...
     return api.sendMessage("️রাগ করে না বেবি এতো রাগ শরীরের জন্য ভালো না🥰", threadID);
   ...
   if ((event.body.toLowerCase() == "হুম") || (event.body.toLowerCase() == "Hum")) {
     ...
     return api.sendMessage("️সাওওয়া এর হুম 🥱", threadID);
   ...
   if ((event.body.toLowerCase() == "Name") || (event.body.toLowerCase() == "name") || (event.body.toLowerCase() == "Tor nam ki")) {
     ...
     return api.sendMessage("️MY NAME IS °_>ITACHI UCHIHA 💌✨", threadID);
   ...
   if ((event.body.toLowerCase() == "😒") || (event.body.toLowerCase() == "🙄")) {
     ...
     return api.sendMessage("️ Tera Hero idhar he Sweety 😽❤️‍🩹 ", threadID);
   ...
   if ((event.body.toLowerCase() == "AMAKE KEW VALOBASHE NA") || (event.body.toLowerCase() == "amake kew valobashe na") || (event.body.toLowerCase() == "Aj kew nai bole")) {
     ...
     return api.sendMessage("️চিন্তা করো কেন সজিব সার তো আছে 🌹🫶/nতোমাকে ভালোবাসবে😽", threadID);
   ...
   if ((event.body.toLowerCase() == "gf") || (event.body.toLowerCase() == "bf")) {
     ...
     return api.sendMessage("খালি কি তোরাই পেম করবি সজিব সারকেউ একটা গফ দে<😿", threadID);
   ...
   if ((event.body.toLowerCase() == "🥰") || (event.body.toLowerCase() == "😍") || (event.body.toLowerCase() == "😻") || (event.body.toLowerCase() == "❤️")) {
     ...
     return api.sendMessage("ভালোবাসা নামক আবলামী করতে চাইলে সজিব সার এর ইনবক্সে চলে যান 🌚🐸", threadID);
   ...
   if ((event.body.toLowerCase() == "i love you") || (event.body.toLowerCase() == "Love you") || (event.body.toLowerCase() == "I Love You") || (event.body.toLowerCase() == "ভালোবাসি") || (event.body.toLowerCase() == "i love you")) {
     ...
     return api.sendMessage("আলাবু টু ঝাং 🥺", threadID);
     ...
     return api.sendMessage("চিপায় গেলে সজিব সারকে নিয়ে যাও ..!🌚🌶️🍆⛏️", threadID);
   ...
   if ((event.body.toLowerCase() == "tumi ki amake bhalobaso") || (event.body.toLowerCase() == "tmi ki amake vlo basho")) {
     ...
     return api.sendMessage("সজিব সার তোমাকে অনেক ভালোবাসে  <😿🌹", threadID);
